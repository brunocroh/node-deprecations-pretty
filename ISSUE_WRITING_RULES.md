...
- CommonJS: `const module = require('node:module')`
- CommonJS Destructured imports: `const { func } = require('node:module')`
- CommonJS Destructured with renaming: `const { func: renamedFunc } = require('node:module')`
- ESM Named imports: `import { } from 'node:module'`
- ESM Namespace imports: `import * as module from 'node:module'`
- ESM Default imports: `import module from 'node:module'`
- ESM Alias imports: `import { func as renamedFunc } from 'node:module'`
- Dynamic imports: `const mod = await import('node:module')`
...
- **Examples**: 6-9 cases focusing on detection scenarios
...
- **Examples**: 10-12 comprehensive cases
